            ...
            try {
                ...
                if (message.startsWith("#")){
                    if ("#开始聊天".equals(message)){
                        ...
                        aiMessage = "已开启连续聊天，会增加tokens的使用量，请不要过长连续聊天，30分钟未关闭连续聊天，则会自动关闭。";
                    ...
                    aiMessage = "1.如果只想让AI回答问题，请直接输入问题；\n" +
                            "2.如果要生成图片请说：【#生成图片 描述】；\n" +
                            "3.输入【#查询余额】可以查询当前key的剩余美元；\n" +
                            "4.输入【#开始聊天】，即可开始连续聊天，输入【#结束聊天】，即可结束聊天；\n" +
